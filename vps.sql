...
create table service_info (
  ...
  shadowsocks_port       varchar(10)    default ''                 comment 'shadowsocks_端口',
  shadowsocks_password   varchar(20)    default ''                 comment 'shadowsocks_密码',
  shadowsocks_protocol   varchar(100)    default ''                 comment 'shadowsocks_协议',
  shadowsocks_confusion  varchar(100)    default ''                 comment 'shadowsocks_混淆协议',
  shadowsocks_createtime 	   timestamp null default CURRENT_TIMESTAMP()       comment 'shadowsocks_创建时间',
  shadowsocks_updatetime       timestamp null default CURRENT_TIMESTAMP()        comment 'shadowsocks_更新时间',
  vshadowsocks_remark          varchar(500)    default null               comment 'shadowsocks_备注',
